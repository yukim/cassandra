...
public class StreamTransferTaskTest
{
    ...
    public void testScheduleTimeout() throws Exception
    {
        ...
        StreamSession session = new StreamSession(peer, peer, null, 0, true, false, null, false);
        ColumnFamilyStore cfs = Keyspace.open(KEYSPACE1).getColumnFamilyStore(CF_STANDARD);
    ...
    {
        InetAddress peer = FBUtilities.getBroadcastAddress();
        StreamCoordinator streamCoordinator = new StreamCoordinator(1, true, false, null, false, null, false);
