...
public class StreamStateStoreTest
{
    ...
    public void testUpdateAndQueryAvailableRanges()
    {
        ...
        StreamSession session = new StreamSession(local, local, new DefaultConnectionFactory(), 0, true, false, null, false);
        ...
        session = new StreamSession(local, local, new DefaultConnectionFactory(), 0, true, false, null, false);
