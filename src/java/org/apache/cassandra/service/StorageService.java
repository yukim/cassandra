...
import org.apache.cassandra.repair.StreamingRepairRequestVerbHandler;
import org.apache.cassandra.repair.TreeRequestVerbHandler;
...
public class StorageService extends NotificationBroadcasterSupport implements IEndpointStateChangeSubscriber, StorageServiceMBean
{
    ...
    public StorageService()
    {
        ...
        MessagingService.instance().registerVerbHandlers(MessagingService.Verb.STREAMING_REPAIR_REQUEST, new StreamingRepairRequestVerbHandler());
