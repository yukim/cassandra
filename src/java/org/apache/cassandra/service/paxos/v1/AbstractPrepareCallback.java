...
public abstract class AbstractPrepareCallback extends AbstractPaxosCallback<PrepareResponse>
{
    private static final Logger logger = LoggerFactory.getLogger(AbstractPrepareCallback.class);
    ...
    public AbstractPrepareCallback(DecoratedKey key, TableMetadata metadata, ReplicaPlan.ForPaxosWrite replicaPlan, long queryStartNanoTime)
    {
    ...
    public synchronized void onResponse(Message<PrepareResponse> message)
    {
        ...
        signalWhenReady(message);
    }

    protected abstract void signalWhenReady(Message<PrepareResponse> message);
