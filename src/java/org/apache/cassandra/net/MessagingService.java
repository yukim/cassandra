...
public final class MessagingService implements MessagingServiceMBean
{
    ...
    {{
        ...
        put(Verb.TREE_REQUEST, TreeRequest.serializer);
        put(Verb.TREE_RESPONSE, ValidatorSerializer.instance);
        put(Verb.STREAMING_REPAIR_REQUEST, StreamingRepairTaskSerializer.instance);
