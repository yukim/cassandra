...
public class IncomingStreamingConnection extends Thread implements Closeable
{
    ...
    public void run()
    {
        try
        {
            ...
            StreamResultFuture.initReceivingSide(init.sessionIndex, init.planId, init.description, init.from, this, init.isForOutgoing, version, init.keepSSTableLevel, init.isIncremental, init.pendingRepair, init.isPreview);
        }
        catch (Throwable t)
        {
