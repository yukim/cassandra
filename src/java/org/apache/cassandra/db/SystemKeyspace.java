...
public final class SystemKeyspace
{
    ...
    */
    ...
    private static ByteBuffer rangeToBytes(Range<Token> range)
    {
        ...
        {
            DataOutputBuffer out = new DataOutputBuffer();
            Range.serializer.serialize(range, out, MessagingService.VERSION_30);
    ...
    private static Range<Token> byteBufferToRange(ByteBuffer rawRange, IPartitioner partitioner)
    {
        try
        {
            return (Range<Token>) Range.serializer.deserialize(ByteStreams.newDataInput(ByteBufferUtil.getArray(rawRange)),
                                                               partitioner,
