...
public class CompactionTask extends AbstractCompactionTask
{
    ...
    protected void runMayThrow() throws Exception
    {
        ...
        assert sstables != null && currentDisk != null;
        ...
        try
        {
            ...
            SSTableWriter writer = cfs.createCompactionWriter(keysPerSSTable, currentDisk, toCompact);
            writers.add(writer);
            while (nni.hasNext())
            {
                ...
                if (!nni.hasNext() || newSSTableSegmentThresholdReached(writer))
                {
                    ...
                    if (nni.hasNext())
                    {
                        writer = cfs.createCompactionWriter(keysPerSSTable, currentDisk, toCompact);
                        writers.add(writer);
