...
public class Validator implements Runnable
{
    ...
    public void fail()
    {
        ...
        if (MessagingService.instance().getVersion(initiator) > MessagingService.VERSION_12)
        {
    ...
    public void run()
    {
        ...
        try
        {
            ...
            {
                MessageOut<Validator> message = new MessageOut<>(MessagingService.Verb.TREE_RESPONSE, this, ValidatorSerializer.instance);
                MessagingService.instance().sendOneWay(message, initiator);
            }
        }
        catch (Exception e)
        {
