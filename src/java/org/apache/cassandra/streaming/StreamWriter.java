 ...
 */
public class StreamWriter extends ProgressSupport
{
    ...
    public StreamWriter(SSTableReader sstable, Collection<Pair<Long, Long>> sections, StreamMessageListener listener, RateLimiter limiter)
    {
        super(ProgressSupport.OUT, listener);
        ...
        try
        {
            ...
            for (Pair<Long, Long> section : sections)
            {
                ...
                while (bytesTransferred < length)
                {
                    ...
                    progress += lastWrite;
                    maybeFireProgressEvent(sstable.descriptor, progress);
                    skipBytes = 0;
                }
