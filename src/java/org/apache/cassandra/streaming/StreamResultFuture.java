...
public final class StreamResultFuture extends AbstractFuture<StreamState>
{
    ...
    private StreamResultFuture(UUID planId, String description, boolean keepSSTableLevels, boolean isIncremental, UUID pendingRepair, boolean preview)
    {
        this(planId, description, new StreamCoordinator(0, keepSSTableLevels, isIncremental, new DefaultConnectionFactory(), false, pendingRepair, preview));
    }
                                                                    ...
                                                                    boolean preview) throws IOException
    {
        ...
        if (future == null)
        {
            ...
            future = new StreamResultFuture(planId, description, keepSSTableLevel, isIncremental, pendingRepair, preview);
