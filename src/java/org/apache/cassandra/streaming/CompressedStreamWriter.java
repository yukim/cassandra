...
public class CompressedStreamWriter extends StreamWriter
{
    ...
    public CompressedStreamWriter(SSTableReader sstable, Collection<Pair<Long, Long>> sections, CompressionInfo compressionInfo, StreamMessageListener listener, RateLimiter limiter)
    {
        super(sstable, sections, listener, limiter);
